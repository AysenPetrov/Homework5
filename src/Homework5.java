...
public class Homework5 {
    public static void main(String[] args) {
        ...
        employeeDb[1] = new Employee("Kim Chen In", "Designer", "Kimchi@mailbox.com", "+79451234565", 40500, 42);
        employeeDb[2] = new Employee("Vasilieva Natasha", "Developer", "VasNatasha@mailbox.com", "+79350801234", 45500, 32);
        employeeDb[3] = new Employee("Nikolay Gromov", "Programmer", "Grom042@mailbox.com", "+72251234548", 60000, 35);
